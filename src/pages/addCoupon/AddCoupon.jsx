...
import AddCouponForm from '../../component/addform/AddCouponForm';
const AddCoupon = () => {
  return (
    <>
        <NavBar>
...
<Box sx={{display:"flex",}}> <AddCircleOutlineIcon/>
      <Typography variant="h5" sx={{fontFamily:'Rubik',color:"black",marginLeft:"4px"}} >Add Coupon </Typography></Box>
      ...
      >< FormatListBulletedIcon/>Coupon List</Button>
      </Box>
